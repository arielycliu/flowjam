label nostro:
    ...
    nostro "{ink}Ah, well. Times are changing. That is inevitable. We can only hope to change them for the better.{/ink}"
    ...
    nostro "I amm sure a deity like you can appreciate a good wine."
    ...
    nostro "Why, {ink}a god who has never had wine is like a king who has never seen gold!{/ink}"
    ...
    show nostro knowing
    nostro "{ink}We mortals can live very long. If not in life, then in spirit.{/ink} And I intend to lead a very long life indeed." 
    ...
    nostro "And in the unlikely case of failure - {ink}at least I will go to my own death knowing that I have not let my dreams slip idly by.{/ink}"
    ...
    # MENU WHERE YOU CAN HELP (USE A LINE FROM FUTURE GIRL)
        nostro "Er, sorry, but I am not really certain how that phrase is helpful in this scenario."
